...
-- Tracks all mutations to the project brain with audit trail, provenance, and versioning.

-- Add mutation metadata to existing project_versions table
...
-- Create project_brain_mutations table for canonical mutation audit trail
...
-- Enable RLS and scope access to workspace members via project_id
