...
/* ProjectX visual system — presentation only */
#px-app{background:#f6f7f9;color:#20242a}
#px-app .logo-wrap{display:flex;align-items:center;gap:9px;padding:0 10px 24px}
#px-app .logo-wrap .logo{padding:0}
#px-app .logo-mark{width:24px;height:24px;display:grid;place-items:center;color:#ff5a24}
#px-app .logo-mark svg{width:22px;height:22px}
#px-app .side-account-action{width:100%;margin-top:9px;border:1px solid #e1e4e8;background:#fff;color:#68707a;border-radius:7px;padding:7px 8px;font-size:10px;cursor:pointer}
#px-app .side-account-action:hover{background:#f3f4f6;color:#171a1f}
#px-app.session-ui{background:#141416}
#px-app.session-ui .side{background:#1b1b1e;border-right:1px solid #2c2c30;color:#f1f1f3}
#px-app.session-ui .logo{color:#f1f1f3}
#px-app.session-ui .logo-mark{color:#ff6a37}
#px-app.session-ui .new{background:#252528;border-color:#343439;color:#fff}
#px-app.session-ui .new:hover{background:#2b2b2f}
#px-app.session-ui .nav button,#px-app.session-ui .recent button{color:#9b9ba2}
#px-app.session-ui .nav button.active,#px-app.session-ui .nav button:hover,#px-app.session-ui .recent button:hover{background:#29292d;color:#fff}
#px-app.session-ui .divider{background:#2e2e32}
#px-app.session-ui .label{color:#77777e}
#px-app.session-ui .acct{background:#222225;border-color:#333338;color:#dadadd}
#px-app.session-ui .acct .sub{color:#8f8f96}
#px-app.session-ui .side-account-action{background:#29292d;border-color:#39393f;color:#bdbdc3}
#px-app.session-ui .side-account-action:hover{background:#303035;color:#fff}
#px-app.session-ui .main{background:#141416}
#px-app.session-ui .top{display:none}
#px-app.session-ui .workspace-home-screen{background:transparent}
.workspace-home{min-height:100%;background:radial-gradient(600px 280px at 50% 78%,rgba(102,55,33,.22),transparent 70%),#141416;color:#ededf0;overflow:auto}
.workspace-home-inner{width:min(830px,calc(100% - 36px));margin:0 auto;padding:clamp(90px,14vh,145px) 0 80px}
.workspace-kicker{text-align:center;font-size:9px;letter-spacing:.18em;color:#707078;font-weight:800}
.workspace-home h1{text-align:center;margin:12px 0 9px;font-size:clamp(37px,5vw,55px);line-height:1.03;letter-spacing:-.06em;font-weight:600;color:#efeff1}
.workspace-home-sub{max-width:665px;margin:0 auto;text-align:center;color:#8d8d94;font-size:13px;line-height:1.65}
.workspace-suggested{margin:28px auto 0}
.workspace-section-label{color:#77777e;font-size:10px;margin-bottom:8px}
.workspace-suggestion-row{display:flex;gap:7px;justify-content:center;flex-wrap:wrap}
.workspace-suggestion-row button{border:1px solid #35353a;background:#202023;color:#c7c7cc;border-radius:999px;padding:8px 11px;font-size:10px;cursor:pointer}
.workspace-suggestion-row button:hover{background:#28282c;color:#fff}
.workspace-command{margin:21px auto 0;background:#202023;border:1px solid #35353a;border-radius:14px;overflow:hidden;box-shadow:0 16px 50px rgba(0,0,0,.18)}
.workspace-command textarea{width:100%;height:115px;border:0;outline:0;resize:none;background:transparent;color:#eeeef0;padding:17px;font-size:13px;line-height:1.55}
.workspace-command textarea::placeholder{color:#74747b}
.workspace-command-footer{display:flex;align-items:center;gap:8px;border-top:1px solid #303034;padding:8px;color:#75757c;font-size:9px}
.workspace-command-footer span{flex:1;text-align:center}
.workspace-command-footer button{width:31px;height:31px;border:0;border-radius:8px;background:transparent;color:#8f8f96;font-size:20px;cursor:pointer}
.workspace-command-footer button:last-child{background:#f0f0f1;color:#161619;font-size:16px}
.workspace-quick-actions{display:flex;justify-content:center;gap:7px;flex-wrap:wrap;margin-top:14px}
.workspace-quick-actions button{border:1px solid #323237;background:#1d1d20;color:#95959c;border-radius:8px;padding:7px 10px;font-size:9px;cursor:pointer}
.workspace-quick-actions button:hover{background:#26262a;color:#fff}
.public-home{min-height:100vh;background:#faf8f5;color:#303238;overflow:auto}
.public-header{height:72px;width:min(1130px,calc(100% - 36px));margin:0 auto;display:flex;align-items:center;gap:28px}
.public-brand{display:flex;align-items:center;gap:8px;border:0;background:none;color:#303238;font-size:20px;font-weight:800;letter-spacing:-.045em;cursor:pointer;padding:0}
.public-brand-mark{width:24px;height:24px;display:grid;place-items:center;color:#ff5520}.public-brand-mark svg{width:22px;height:22px}
.public-links{display:flex;gap:27px;margin-left:auto}.public-links a{text-decoration:none;color:#64666a;font-size:11px}.public-links a:hover{color:#25272a}
.public-actions{display:flex;gap:8px}.public-login,.public-create{height:38px;padding:0 13px;border-radius:8px;font-size:11px;font-weight:600;cursor:pointer}.public-login{border:1px solid #ddd9d4;background:transparent;color:#4f5358}.public-create{border:1px solid #ff5520;background:#ff5520;color:#fff}
.public-hero{width:min(920px,calc(100% - 30px));margin:0 auto;text-align:center;padding:112px 0 32px}.public-kicker{font-size:9px;letter-spacing:.17em;color:#9b9792;font-weight:800}.public-hero h1{margin:16px 0 11px;font-size:clamp(46px,7vw,74px);line-height:1.01;letter-spacing:-.068em;font-weight:500;color:#3d3e43}.public-hero>p{max-width:690px;margin:0 auto;color:#76787d;font-size:14px;line-height:1.65}
.public-command{max-width:780px;margin:31px auto 0;border:1px solid #ddd9d4;background:#fff;border-radius:15px;overflow:hidden;box-shadow:0 9px 28px rgba(48,41,35,.05);text-align:left}
.public-command textarea{display:block;width:100%;height:108px;border:0;outline:0;resize:none;padding:17px 18px;background:transparent;color:#2f3136;font-size:13px;line-height:1.55}.public-command textarea::placeholder{color:#9b9b9f}
.public-command-footer{display:flex;align-items:center;gap:8px;border-top:1px solid #eeeae6;padding:8px;color:#999a9e;font-size:9px}.public-command-footer span{flex:1;text-align:center}.public-command-footer button{width:32px;height:32px;border:0;border-radius:8px;background:transparent;color:#7d8085;font-size:21px;cursor:pointer}.public-command-footer button:last-child{background:#ff5a24;color:#fff;font-size:16px}
.public-scope{display:flex;justify-content:center;gap:9px;flex-wrap:wrap;margin-top:17px}.public-scope button{width:105px;border:1px solid #e1ddd8;background:rgba(255,255,255,.74);border-radius:11px;padding:10px 8px;color:#56595f;cursor:pointer}.public-scope button:hover{background:#fff;border-color:#cbc6bf}.public-scope b{display:block;font-size:10px;font-weight:700}.public-scope small{display:block;margin-top:4px;color:#949497;font-size:8px}
.public-examples{width:min(880px,calc(100% - 30px));margin:7px auto 58px;text-align:center}.public-section-heading{font-size:10px;color:#8b8d91;margin-bottom:10px}.public-section-heading button{border:0;background:none;color:#686b70;cursor:pointer}.public-example-row{display:flex;justify-content:center;gap:8px;flex-wrap:wrap}.public-example-chip{border:1px solid #ddd9d4;background:#fff;color:#55585e;border-radius:8px;padding:8px 11px;font-size:10px;cursor:pointer}.public-example-chip:hover{border-color:#c7c1ba;color:#25272b}
.public-how{width:min(880px,calc(100% - 30px));margin:0 auto 80px;padding:21px 0;border-top:1px solid #e5e1dc;text-align:center}.public-how-line{font-size:9px;letter-spacing:.16em;color:#a09d99}.public-how-line span{margin:0 8px;color:#c0bbb5}.public-how p{max-width:620px;margin:9px auto 0;color:#8e8e92;font-size:11px;line-height:1.6}
.auth-refined{display:none}
#px-app .modal-bg .modal{border-radius:16px;border:1px solid #e3ded7;background:#faf8f5;color:#2f3135;box-shadow:0 24px 90px rgba(0,0,0,.24)}
#px-app .modal-bg .modal h2{font-weight:600;color:#2b2d32}
#px-app .modal-bg .modal .input{background:#fff;border-color:#ddd8d1;color:#2f3135}
#px-app .modal-bg .modal .input:focus{border-color:#b9b2aa}
#px-app .modal-bg .modal .ghost{background:transparent;border-color:#dad5cf;color:#55595f}
#px-app .modal-bg .modal .primary{background:#202124;border-color:#202124}
@media(max-width:760px){
 .public-header{width:calc(100% - 20px);height:64px}.public-links{display:none}.public-actions{margin-left:auto}.public-login,.public-create{height:35px}.public-hero{padding-top:78px}.public-hero h1{font-size:clamp(42px,12vw,62px)}.public-command-footer span{display:none}.public-scope button{width:92px}.workspace-home-inner{width:calc(100% - 24px);padding-top:72px}.workspace-home h1{font-size:clamp(35px,10vw,50px)}.workspace-home-sub{font-size:12px}
}
...
function shell(body, active='home'){
  ...
  root.classList.toggle('session-ui',Boolean(session));
  const recents=state.projects.slice(0,6);
  root.innerHTML=`<aside class="side">
    <div class="logo-wrap"><div class="logo-mark" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="8.5" fill="none" stroke="currentColor" stroke-width="1.9"/><circle cx="12" cy="12" r="2.1" fill="currentColor"/></svg></div><div class="logo">ProjectX</div></div>
    ...
    <nav class="nav" aria-label="Workspace navigation">
      ...
      <button data-nav="projects" class="${active==='projects'?'active':''}">Projects</button>
      <button data-nav="assistant" class="${active==='assistant'?'active':''}">Assistant</button>
      <button data-nav="analytics" class="${active==='analytics'?'active':''}">Analytics</button>
      <button data-nav="settings" class="${active==='settings'?'active':''}">Settings</button>
    </nav>
    <div class="divider"></div>
    <div class="label">Recent</div>
    <div class="recent">${recents.map(p=>`<button data-open="${esc(p.id)}">${esc(p.title)}</button>`).join('')||'<div class="sub" style="padding:6px 10px">No projects yet</div>'}</div>
    <div class="acct">
      <div class="acct-main">${session?.user?.email?esc(session.user.email):'Guest workspace'}<div class="sub" style="font-size:10px;margin-top:2px">${session?'Cloud sync enabled':'Local sync enabled'}</div></div>
      <button class="side-account-action" data-action="${session?'signout':'signin'}">${session?'Sign out':'Sign in'}</button>
    </div>
  </aside>
  <main class="main"><div class="top"><button data-nav="home">Home</button>${session?'<button data-action="signout">Sign out</button>':'<button data-action="signin">Sign in</button>'}</div>${body}</main>`;
...
function workspaceHome(){
  ...
  const name=(session?.user?.user_metadata?.full_name||session?.user?.user_metadata?.name||email.split('@')[0]||'there').split(' ')[0];
  shell(`<section class="workspace-home">
    <div class="workspace-home-inner">
      <div class="workspace-kicker">PROJECTX WORKSPACE</div>
      <h1>${esc(name)}, what are we working on?</h1>
      <p class="workspace-home-sub">Start with an idea, goal, problem, or task. ProjectX figures out the kind of work and gives you the structure to move it forward.</p>

      <div class="workspace-suggested">
        <div class="workspace-section-label">Suggested for you</div>
        <div class="workspace-suggestion-row">
          <button data-home-example="Turn my idea into a clear plan">✦ <span>Turn an idea into a plan</span></button>
          <button data-home-example="Research a problem and organize the evidence">⌕ <span>Research a problem</span></button>
          <button data-home-example="Plan a business from scratch">◫ <span>Plan a business</span></button>
        </div>
      </div>

      <div class="workspace-command">
        <textarea id="start-input" placeholder="Start chatting or describe what you want to accomplish…"></textarea>
        <div class="workspace-command-footer">
          <button id="home-focus" type="button" aria-label="Focus command box">+</button>
          <span>ProjectX can plan, research, build, create, test, and coordinate work.</span>
          <button id="start-send" type="button" aria-label="Start project">↑</button>
        </div>
      </div>

      <div class="workspace-quick-actions">
        <button data-home-example="Build a website or web app for me">Build</button>
        <button data-home-example="Research this topic and organize the evidence">Research</button>
        ...
        <button data-home-example="Plan and launch a small business">Business</button>
      </div>
    </div>
  </section>`,'home');
  ...
  $('#home-focus').onclick=()=>input.focus();
  input.onkeydown=e=>{if((e.ctrlKey||e.metaKey)&&e.key==='Enter'){e.preventDefault();send();}};
  $$('.workspace-home [data-home-example]').forEach(button=>button.onclick=()=>{input.value=button.dataset.homeExample||'';input.focus();});
}
function publicHome(){
  const root=ensureShell();
  root.classList.remove('session-ui');
  root.innerHTML=`<div class="public-home">
    <header class="public-header">
      <button class="public-brand" id="public-brand" aria-label="ProjectX home">
      ...
      <nav class="public-links" aria-label="Public navigation">
        <a href="#public-how">How it works</a>
        <a href="#public-examples">Examples</a>
        <a href="#public-scope">What it can do</a>
      </nav>
      <div class="public-actions">
        <button class="public-login" id="public-signin">Sign in</button>
        <button class="public-create" id="public-signup">Create account</button>
      </div>
    </header>

    <main>
      <section class="public-hero" id="public-build">
        <div class="public-kicker">ONE WORKSPACE · MANY KINDS OF WORK</div>
        <h1>What are you trying to make real?</h1>
        <p>Tell ProjectX the outcome. It can understand the work, ask what matters, build the right plan, create outputs, research what is needed, and help you execute.</p>

        <div class="public-command">
          <textarea id="public-input" placeholder="Tell ProjectX what you want to accomplish…"></textarea>
          <div class="public-command-footer">
            <button id="public-focus" type="button" aria-label="Focus prompt">+</button>
            <span>Start with the outcome — not the structure.</span>
            <button id="public-send" type="button" aria-label="Start with ProjectX">↑</button>
          </div>
        </div>

        <div class="public-scope" id="public-scope">
          <button data-public-example="Build a website for my business"><b>Build</b><small>Web, apps, games</small></button>
          <button data-public-example="Research this problem and give me an evidence-backed plan"><b>Research</b><small>Evidence & insight</small></button>
          <button data-public-example="Create a business plan for my idea"><b>Business</b><small>Plans & execution</small></button>
          <button data-public-example="Create a presentation or document for this project"><b>Create</b><small>Outputs & deliverables</small></button>
          <button data-public-example="Plan this goal into practical next steps"><b>Plan</b><small>Tasks & checklists</small></button>
          <button data-public-example="Help me solve this real-world problem"><b>Solve</b><small>Beyond software</small></button>
        </div>
      </section>

      <section class="public-examples" id="public-examples">
        <div class="public-section-heading">Try an example <button id="public-example-refresh" type="button" aria-label="Refresh examples">↻</button></div>
        <div class="public-example-row">
          <button class="public-example-chip" data-public-example="Build a sales pipeline tracker for a small business">Sales pipeline tracker</button>
          <button class="public-example-chip" data-public-example="Create a study system for my subjects and deadlines">Study system</button>
          <button class="public-example-chip" data-public-example="Plan a small product launch from idea to execution">Product launch plan</button>
          <button class="public-example-chip" data-public-example="Create a multiplayer game concept and build plan">Game concept</button>
        </div>
      </section>

      <section class="public-how" id="public-how">
        <div class="public-how-line">UNDERSTAND <span>→</span> PLAN <span>→</span> BUILD <span>→</span> VERIFY</div>
        <p>ProjectX adapts the workspace to the work — software, research, business, creative projects, games, or real-world goals.</p>
      </section>
    </main>
  </div>`;
  $('#public-brand').onclick=()=>location.hash='';
  $('#public-signin').onclick=()=>authModal();
  $('#public-signup').onclick=()=>authModal();
  $('#public-focus').onclick=()=>$('#public-input').focus();

  const input=$('#public-input');
  const send=async()=>{const value=input.value.trim();if(!value){input.focus();return;}await beginCreation(value);};
  $('#public-send').onclick=send;
  input.onkeydown=e=>{if((e.ctrlKey||e.metaKey)&&e.key==='Enter'){e.preventDefault();send();}};
  $$('.public-home [data-public-example]').forEach(button=>button.onclick=()=>{input.value=button.dataset.publicExample||'';input.focus();});
  ...
  $('#public-example-refresh').onclick=()=>{
    ...
    $$('.public-example-chip').forEach((button,i)=>{button.textContent=examples[i][0];button.dataset.publicExample=examples[i][1];});
  };
}
function home(){
  if(session){workspaceHome();return;}
  publicHome();
}
