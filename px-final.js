...
/* Home-only presentation layer. Shared app shell and feature pages remain untouched. */
#px-app.projectx-home-active{background:#f8f9fb}
#px-app.projectx-home-active .side{background:#1a1a1d;border-right-color:#2d2d31;color:#f2f2f4}
#px-app.projectx-home-active .logo{color:#f2f2f4}
#px-app.projectx-home-active .new{background:#252528;border-color:#35353a;color:#fff}
#px-app.projectx-home-active .nav button,#px-app.projectx-home-active .recent button{color:#a0a0a6}
#px-app.projectx-home-active .nav button.active,#px-app.projectx-home-active .nav button:hover,#px-app.projectx-home-active .recent button:hover{background:#29292d;color:#fff}
#px-app.projectx-home-active .label{color:#77777e}
#px-app.projectx-home-active .divider{background:#2f2f33}
#px-app.projectx-home-active .acct{background:#222225;border-color:#343439;color:#dadadd}
#px-app.projectx-home-active .acct .sub{color:#8f8f96}
#px-app.projectx-home-active .main{background:#141416}
#px-app.projectx-home-active .top{display:none}
.workspace-home{min-height:100%;background:radial-gradient(580px 300px at 50% 78%,rgba(104,58,36,.20),transparent 70%),#141416;color:#ededf0;overflow:auto}
.workspace-home-inner{width:min(820px,calc(100% - 34px));margin:0 auto;padding:clamp(86px,14vh,138px) 0 70px}
.workspace-home-kicker{text-align:center;font-size:9px;letter-spacing:.18em;color:#74747c;font-weight:800}
.workspace-home h1{text-align:center;margin:12px 0 9px;font-size:clamp(37px,5vw,55px);line-height:1.03;letter-spacing:-.06em;color:#efeff1;font-weight:600}
.workspace-home-sub{max-width:650px;margin:0 auto;text-align:center;color:#8d8d95;font-size:13px;line-height:1.65}
.workspace-suggested{margin:27px auto 0}.workspace-section-label{color:#77777e;font-size:10px;margin-bottom:8px}
.workspace-suggestion-row{display:flex;justify-content:center;gap:7px;flex-wrap:wrap}
.workspace-suggestion-row button{border:1px solid #36363b;background:#202023;color:#c8c8cd;border-radius:999px;padding:8px 11px;font-size:10px;cursor:pointer}
.workspace-suggestion-row button:hover{background:#29292d;color:#fff}
.workspace-command{margin-top:21px;border:1px solid #37373c;border-radius:14px;background:#202023;overflow:hidden;box-shadow:0 15px 50px rgba(0,0,0,.20)}
.workspace-command textarea{display:block;width:100%;height:116px;border:0;outline:0;resize:none;padding:17px;background:transparent;color:#f0f0f2;font-size:13px;line-height:1.55}
.workspace-command textarea::placeholder{color:#77777e}.workspace-command-footer{display:flex;align-items:center;gap:8px;padding:8px;border-top:1px solid #303034;color:#77777e;font-size:9px}.workspace-command-footer span{flex:1;text-align:center}.workspace-command-footer button{width:31px;height:31px;border:0;border-radius:8px;background:transparent;color:#92929a;font-size:20px;cursor:pointer}.workspace-command-footer button:last-child{background:#f0f0f1;color:#171719;font-size:16px}
.workspace-quick-actions{display:flex;justify-content:center;gap:7px;flex-wrap:wrap;margin-top:14px}.workspace-quick-actions button{border:1px solid #323237;background:#1d1d20;color:#9999a0;border-radius:8px;padding:7px 10px;font-size:9px;cursor:pointer}.workspace-quick-actions button:hover{background:#27272b;color:#fff}

#px-app.projectx-public-home{background:#faf8f5;color:#303238}
.public-home{min-height:100%;background:#faf8f5;color:#303238;overflow:auto}
.public-header{height:72px;width:min(1120px,calc(100% - 36px));margin:0 auto;display:flex;align-items:center;gap:28px}
...
.public-brand-mark{width:24px;height:24px;display:grid;place-items:center;color:#ff5724}.public-brand-mark svg{width:22px;height:22px}
.public-links{display:flex;gap:28px;margin-left:auto}.public-links a{text-decoration:none;color:#62656a;font-size:11px}.public-links a:hover{color:#22252a}
.public-actions{display:flex;gap:8px}.public-login,.public-create{height:38px;padding:0 13px;border-radius:8px;font-size:11px;font-weight:600;cursor:pointer}.public-login{border:1px solid #dedad4;background:transparent;color:#4e5258}.public-create{border:1px solid #ff5724;background:#ff5724;color:#fff}
.public-hero{width:min(900px,calc(100% - 30px));margin:0 auto;text-align:center;padding:113px 0 30px}.public-kicker{font-size:9px;letter-spacing:.18em;color:#9b9792;font-weight:800}.public-hero h1{margin:15px 0 11px;font-size:clamp(46px,7vw,74px);line-height:1.01;letter-spacing:-.068em;font-weight:500;color:#3d3e43}.public-hero>p{max-width:690px;margin:0 auto;color:#76797e;font-size:14px;line-height:1.65}
.public-command{max-width:770px;margin:31px auto 0;border:1px solid #ddd9d4;background:#fff;border-radius:15px;overflow:hidden;box-shadow:0 9px 30px rgba(44,37,30,.05);text-align:left}.public-command textarea{display:block;width:100%;height:108px;border:0;outline:0;resize:none;padding:17px 18px;background:transparent;color:#303238;font-size:13px;line-height:1.55}.public-command textarea::placeholder{color:#999a9e}.public-command-footer{display:flex;align-items:center;gap:8px;border-top:1px solid #eeeae6;padding:8px;color:#999a9e;font-size:9px}.public-command-footer span{flex:1;text-align:center}.public-command-footer button{width:32px;height:32px;border:0;border-radius:8px;background:transparent;color:#7c7f84;font-size:21px;cursor:pointer}.public-command-footer button:last-child{background:#ff5a24;color:#fff;font-size:16px}
.public-scope{display:flex;justify-content:center;gap:9px;flex-wrap:wrap;margin-top:17px}.public-scope button{width:105px;border:1px solid #e0ddd8;background:rgba(255,255,255,.78);border-radius:11px;padding:10px 8px;color:#55585e;cursor:pointer}.public-scope button:hover{background:#fff;border-color:#cac4bd}.public-scope b{display:block;font-size:10px;font-weight:700}.public-scope small{display:block;margin-top:4px;color:#929397;font-size:8px}
.public-examples{width:min(860px,calc(100% - 30px));margin:6px auto 56px;text-align:center}.public-section-heading{font-size:10px;color:#8c8d91;margin-bottom:10px}.public-section-heading button{border:0;background:none;color:#686b70;cursor:pointer}.public-example-row{display:flex;justify-content:center;gap:8px;flex-wrap:wrap}.public-example-chip{border:1px solid #ddd9d4;background:#fff;color:#55585e;border-radius:8px;padding:8px 11px;font-size:10px;cursor:pointer}.public-example-chip:hover{border-color:#c7c1ba;color:#25272b}.public-how{width:min(860px,calc(100% - 30px));margin:0 auto 70px;padding:21px 0;border-top:1px solid #e6e2dd;text-align:center}.public-how-line{font-size:9px;letter-spacing:.16em;color:#a09d99}.public-how-line span{margin:0 8px;color:#beb8b2}.public-how p{max-width:630px;margin:9px auto 0;color:#8e8f93;font-size:11px;line-height:1.6}
@media(max-width:760px){.public-header{width:calc(100% - 20px);height:64px}.public-links{display:none}.public-actions{margin-left:auto}.public-login,.public-create{height:35px}.public-hero{padding-top:78px}.public-hero h1{font-size:clamp(42px,12vw,62px)}.public-command-footer span{display:none}.public-scope button{width:92px}.workspace-home-inner{width:calc(100% - 24px);padding-top:70px}.workspace-home h1{font-size:clamp(35px,10vw,50px)}.workspace-home-sub{font-size:12px}}
...
function workspaceHome(){
  ...
  root.classList.remove('projectx-public-home');
  root.classList.add('projectx-home-active');
  shell(`<section class="workspace-home">
    <div class="workspace-home-inner">
      <div class="workspace-home-kicker">PROJECTX WORKSPACE</div>
      <h1>What are we working on today?</h1>
      <p class="workspace-home-sub">Start with an idea, goal, problem, or task. ProjectX understands the work and builds the right path around it.</p>
  ...
  $$('#px-app.projectx-home-active [data-home-example]').forEach(button=>button.onclick=()=>{input.value=button.dataset.homeExample||'';input.focus();});
}

function publicHome(){
  const root=ensureShell();
  root.classList.remove('projectx-home-active');
  root.classList.add('projectx-public-home');
  root.innerHTML=`<div class="public-home">
    <header class="public-header">
      <button class="public-brand" id="public-brand" type="button" aria-label="ProjectX home">
      ...
      <div class="public-actions">
        <button id="public-signin" class="public-login">Sign in</button>
        <button id="public-signup" class="public-create">Create account</button>
      </div>
    </header>
    ...
    <main>
      <section class="public-hero" id="public-build">
        ...
        <p>Start with the outcome. ProjectX can understand the work, research what matters, create a plan, build what is needed, and help you move it forward.</p>
        ...
        <div class="public-scope" id="public-scope">
          <button data-public-example="Build a website or web app for my project"><b>Build</b><small>Web · apps · games</small></button>
          <button data-public-example="Research this problem and organize the evidence"><b>Research</b><small>Evidence · insight</small></button>
          <button data-public-example="Create a business plan and execution roadmap"><b>Business</b><small>Plan · execute</small></button>
          <button data-public-example="Create a presentation or document for my project"><b>Create</b><small>Outputs · deliverables</small></button>
          <button data-public-example="Turn this goal into a step-by-step plan"><b>Plan</b><small>Tasks · checklists</small></button>
      ...
      <section class="public-examples" id="public-examples">
        ...
        <div class="public-example-row">
          ...
          <button class="public-example-chip" data-public-example="Create a study system around my subjects and deadlines">Study system</button>
          <button class="public-example-chip" data-public-example="Plan a product launch from idea to execution">Product launch plan</button>
          <button class="public-example-chip" data-public-example="Create a game concept and build plan">Game concept</button>
        </div>
      </section>
      ...
      <section class="public-how" id="public-how">
        ...
        <p>ProjectX adapts to the kind of work — software, research, business, creative projects, games, or real-world goals.</p>
      </section>
    </main>
  </div>`;

  $('#public-brand').onclick=()=>{location.hash='';window.scrollTo({top:0,behavior:'smooth'});};
  ...
  const send=async()=>{const value=input.value.trim();if(!value){input.focus();return;}if(!session&&!localGuestKey()){authModal();return;}await beginCreation(value);};
