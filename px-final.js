...
function renderBrain(project){
  ...
  const html=brainList('Understanding',rows)+brainList('Project context',context)+brainList('Plan',planRows)+brainList('Requirements',s.requirements)+brainList('Constraints',s.constraints)+brainList('Decisions',s.decisions)+brainList('Deliverables',s.deliverables)+brainList('Success criteria',s.successCriteria)+brainList('Dependencies',s.dependencies)+brainList('Open questions',s.openQuestions)+brainList('Known resources',s.resources)+
